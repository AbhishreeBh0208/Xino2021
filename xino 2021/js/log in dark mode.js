...
function enableDarkMode () {
   ...
   const navLinks = document.querySelectorAll('.navbar__link');
    ...
    const logInInput = document.querySelectorAll('.login-hero__input');
    logInInput.forEach((input) => {
        input.classList.add('login-hero__input-dark-mode');
    });
...
function disableDarkMode () {
    ...
    const logInInput = document.querySelectorAll('.login-hero__input');
    logInInput.forEach((input) => {
        input.classList.remove('login-hero__input-dark-mode');
    });
