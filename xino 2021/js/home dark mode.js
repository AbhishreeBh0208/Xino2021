...
function enableDarkMode () {
   ...
   const ctaBtn = document.querySelectorAll('.btn-black');
    ...
    const statCaption = document.querySelectorAll('.stat__caption');
    statCaption.forEach((cap) => {
        cap.classList.add('stat__caption-dark-mode');
    });
...
function disableDarkMode () {
    ...
    const statCaption = document.querySelectorAll('.stat__caption');
    statCaption.forEach((cap) => {
        cap.classList.remove('stat__caption-dark-mode');
    });
    const alumnusPost = document.querySelectorAll('.alumnus__post');
    alumnusPost.forEach((post) => {
